        ...
        <div class="panel panel-default">
            <div class="panel-heading" role="tab" id="headingOne">
                ...
                <?php if(!empty($parent->childs)) : ?>
                    ...
                    <a class="<?php echo implode(' ', $classes); ?>" data-toggle="collapse" data-parent="#<?php echo $tag_id; ?>" data-href="<?php echo $parent->href; ?>" href="#<?php echo $parent->html_id; ?>"><?php echo $parent->title; ?></a>
                <?php else: ?>
                    <?php $classes = $parent->classes; ?>
                    <a class="<?php echo implode(' ', $classes); ?>" href="<?php echo $parent->href; ?>"><?php echo $parent->title; ?></a>
                <?php endif; ?>
                </h4>
            </div>
            <?php if(!empty($parent->childs)) : ?>
            <div id="<?php echo $parent->html_id; ?>" class="panel-collapse collapse <?php echo $collapse_status; ?>" role="tabpanel">
